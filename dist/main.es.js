...
var Engine = (function () {
    function Engine(canvas, ctx) {
        ...
        this.canvas = canvas;
        this.ctx = ctx;
        this.frame = interval(0, animationFrame);
...
function lerp(start, end, interval$$1) {
    if (interval$$1 > 1) {
    ...
    return new Vector2({ x: nLerp(start.x, end.x, interval$$1), y: nLerp(start.y, end.y, interval$$1) });
}
...
export { Engine, lerp, BoxHits, CollisionHit, Vector2, Rect, GameObject };
